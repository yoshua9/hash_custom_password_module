...
class CustomerFormatter extends CustomerFormatterCore
{
    ...
    private $partner_optin_is_required = false; //modificada la obligación de marcar optin
    private $ask_for_password = true;
    private $password_is_required = false; //modificada la obligación de introducir password
